...
This project is indexed by GitNexus as **agentic-sdlc-framework** (18 symbols, 10 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
