...
This project is indexed by GitNexus as **agentic-sdlc-framework** (11 symbols, 4 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
