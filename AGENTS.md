...
This project is indexed by GitNexus as **vsaf** (192 symbols, 185 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
